...
-- financial_models.stocks_daily внешние включи

-- ALTER TABLE financial_models.stocks_daily ADD CONSTRAINT stocks_daily_stocks_fk FOREIGN KEY (ticker_id) REFERENCES financial_models.stocks(ticker_id);
...
-- financial_models.trade_execution внешние включи

-- ALTER TABLE financial_models.trade_execution ADD CONSTRAINT trade_execution_stocks_fk FOREIGN KEY (ticker_id) REFERENCES financial_models.stocks(ticker_id);
-- ALTER TABLE financial_models.trade_execution ADD CONSTRAINT trade_execution_users_fk FOREIGN KEY (user_id) REFERENCES financial_models.users(users_id);
